...
class ExpensesCrudController extends CrudController
{
    ...
    public function setup()
    {
        ...
        CRUD::setEntityNameStrings('expenses', 'expenses');
    }
    ...
    {
        CRUD::column('spent_id');
        CRUD::column('date');
        CRUD::column('amount');
        $this->crud->addColumn([
            'name' => 'spent_id',//name="id_cat"
            'label' => 'Spent',
            'type' => 'select',
            'entity' => 'spent',//method relation entre deux models
            'attribute' => 'type',//attribut du model a affiche
            'model' => "App\Models\Spent",
        ]);
